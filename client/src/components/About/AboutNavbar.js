...
const AboutNavbar = () => {
    ...
    <li className='nav_li'><Link to="/about" >Message from the Vice Chancellor</Link></li>
    <li className='nav_li'><a href="./AboutUs.js/#vice_chan" >List of Vice Chancellors</a></li>
