    ...
    return (
        ...
        <div>
            ...
            <div className='max-w-screen-xl mx-auto about_main p-4 bg-white drop-shadow-xl mb-12 about_welcome'>
                <h2 className='text-center about_welcome mt-8'>Welcome to University of Dhaka</h2>
                <h3 className='text-center my-4'>University of Dhaka</h3>
                <div className='about_text'>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-4 mt-4 mx-auto">
                        ...
                        <div className="about_right">
                            ...
                            <p>
                                At the beginning, a distinctive feature of the University of Dhaka was its non-affiliating, residential character like that of the Oxford of England. However, since 1947 the University was given an affiliating mandate in place of an exclusive residential-cum-teaching character.</p>
...
The open-minded character of the University of Dhaka embodying the features of beauty and historical origins can be seen as one enters the campus.</p>
                    </div>
