            ...
            <div className='w-4/5 mx-auto h-3/4 my-12'>
                <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-4 mt-4 mx-auto'>
                    ...
                    <div className="home_about_right text-justify">
                        <p>Welcome to University of Dhaka.On the first day of July 1921 the University of Dhaka opened its doors to students with Sir P.J. Hartog as the first Vice-Chancellor of the University. The University was set up in a picturesque part of the city known as Ramna on 600 acres of land.</p>
