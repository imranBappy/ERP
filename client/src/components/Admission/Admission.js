...
const Admission = () => {
    ...
    const displayStep = (step) => {
        switch (step) {
            case 1:
                return <Personal handleChange={handleChange}></Personal>;
            case 2:
                return <Family handleChange={handleChange}></Family>;
            case 3:
                return <Education handleChange={handleChange}></Education>;
            case 4:
                return <General handleChange={handleChange}></General>
            default:
        }
    };
